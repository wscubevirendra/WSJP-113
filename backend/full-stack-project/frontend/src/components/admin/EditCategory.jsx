...
export default function EditCatefory({ category }) {
    ...
    function submitHandler(e) {
        ...
        axiosAPIinstance.put(`category/update/${category._id}`, payload).then((response) => {
            ...
            <form onSubmit={submitHandler} className="space-y-6">
                ...
                <div>
                    ...
                    <div className="p-4 font-medium">
                        <img className="w-20 rounded-md h-10" src={process.env.NEXT_PUBLIC_CATEGORY_IMAGE_URL + category.image} alt={category.name} />
                    </div>
                </div>
